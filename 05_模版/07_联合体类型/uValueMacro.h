...
#define OPERATOR_CASE_F(n, type_name, tp, va) \
		case uValueType::type_name:os << u.va;break

#define OPERATOR(...) \
		template<typename T>\
		uValue& operator=(const T& t)\
		{\
			type = uValueType::uValueType_Void;\
			v.v = (void*)&t;\
			return *this;\
		}\
		...
		{\
			...
			{\
				...
				case uValueType::uValueType_Void:os << u.v.v;break;\
				default:\
					os << "ERROR";\
					break;\
			}\
